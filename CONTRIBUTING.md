Contributing to AIMA-Kotlin
==========================
:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:  
If you'd like to report a bug or join in the development
of AIMA-Kotlin, then here are some notes on how to do that.
...
to get your changes merged into aima-kotlin.
...
If you're looking for something to work on, have a look at the open issues in the repository [here](https://github.com/samagra14/aima-kotlin/issues).
